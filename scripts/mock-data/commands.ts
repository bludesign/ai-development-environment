...
const DEFINITIONS = {
  ...
  deployStaging: {
    ...
    snapshotDescription:
      "Builds and deploys the API to the staging environment.",
...
const HISTORY: Array<{
  ...
  },
  {
    ...
    durationMinutes: 4,
    exitCode: 1,
    error: "Test Suites: 2 failed, 40 passed, 42 total",
  },
  {
    definition: "runTests",
    agent: "build",
  ...
  },
  {
    ...
    durationMinutes: 2,
    exitCode: 2,
    error: "Staging health check timed out after 120s",
  },
  {
    definition: "runTests",
    agent: "studio",
