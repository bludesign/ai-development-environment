...
const mockTranslations = {
  ...
  agents: {
    ...
    lastSeen: "Last seen",
    never: "Never",
    repositoryDirectories: "Repository directories",
    baseRepoDirectory: "Base repository directory",
    baseRepoDirectoryDescription:
      "Choose the folder on an agent that contains its repositories. Worktree paths inside it are shown relative to this folder.",
    agent: "Agent",
    selectAgent: "Select an online agent",
    noDirectoryAgents: "No online agents support directory browsing.",
