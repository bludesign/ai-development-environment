  ...
  withIntegrationConfigurationEvents(
    {
      ...
      Query: {
        ...
        gitlabAvailableProjects: (
          ...
          checked(context, () =>
            gitLabService.availableProjects(
              args.search,
              args.page,
              args.perPage,
            ),
        ...
        gitlabApiCalls: (
          ...
          checked(context, () =>
            gitLabService.apiCalls(args.limit, args.offset),
          ),
      ...
      Mutation: {
        ...
        createGitLabMergeRequest: (
          ...
          {
            input,
          }: { input: Parameters<GitLabService["createMergeRequest"]>[0] },
          context: GraphQLContext,
        ...
        updateGitLabMergeRequest: (
          ...
          {
            input,
          }: { input: Parameters<GitLabService["updateMergeRequest"]>[0] },
          context: GraphQLContext,
        ...
        mergeGitLabMergeRequest: (
          ...
          {
            input,
          }: { input: Parameters<GitLabService["mergeMergeRequest"]>[0] },
          context: GraphQLContext,
        ...
        deleteGitLabCacheTtlOverride: (
          ...
          checked(context, () =>
            gitLabService.deleteCacheTtlOverride(operation),
          ),
        saveGitLabAutoRetryRule: (
          _root: unknown,
          {
            input,
          }: { input: Parameters<GitLabService["saveAutoRetryRule"]>[0] },
          context: GraphQLContext,
