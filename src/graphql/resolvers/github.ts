  ...
  withIntegrationConfigurationEvents(
    {
      Query: {
        ...
        githubRepositoryWorkflows: (
          ...
          requireControlPlane(context);
          return gitHubService.repositoryWorkflows(
            codebaseRepositoryId,
            source,
          );
        },
      ...
      Mutation: {
        ...
        createGitHubPullRequest: async (
          ...
          {
            input,
          }: { input: Parameters<GitHubService["createPullRequest"]>[0] },
          context: GraphQLContext,
        ) => {
          requireControlPlane(context);
      ...
      Subscription: {
        githubPipelineStatusChanged: {
          subscribe: (
            _root: unknown,
            args: GitHubPipelineStatusSubscriptionInput,
            context: GraphQLContext,
          ) => {
            requireControlPlane(context);
            return gitHubService.pipelineStatus.subscribe(args);
          },
        },
      },
    },
