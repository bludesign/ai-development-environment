      ...
      <CardHeader className="border-b">
        <CardTitle>
          <div className="flex min-w-0 items-center gap-1">
            ...
            <Link
              className="min-w-0 truncate rounded-sm p-1 font-mono hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
      ...
      >
        <TableCell>
          <div className="flex min-w-0 items-center gap-1">
            ...
            <Link
              className="min-w-0 truncate rounded-sm font-mono hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
              href={worktreeDetailHref(worktree.id)}
            >
              {worktree.branch ?? t("detached")}
            </Link>
