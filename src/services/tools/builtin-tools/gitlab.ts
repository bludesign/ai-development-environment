...
export function createGitLabToolGroup(
  ...
  return {
    ...
    tools: [
      ...
      serviceTool({
        name: "gitlab_set_merge_request_labels",
        title: "Set GitLab merge request labels",
        description: "Replace the labels on a GitLab merge request.",
        inputSchema: projectMergeRequest.extend({
      ...
      serviceTool({
        name: "gitlab_request_merge_request_reviewers",
        title: "Request GitLab merge request reviewers",
        description: "Replace the reviewers on a GitLab merge request.",
        inputSchema: projectMergeRequest.extend({
      ...
      serviceTool({
        ...
        description: "Get a GitLab pipeline by project and pipeline ID.",
        inputSchema: z.object({
          projectId: z.string().min(1),
      ...
      serviceTool({
        name: "gitlab_get_auto_retry_rules",
        title: "Get GitLab auto-retry rules",
        description: "List GitLab pipeline auto-retry rules.",
        inputSchema: z.object({
          projectId: z.string().nullable().optional(),
        }),
        service,
      ...
      serviceTool({
        ...
        title: "Save GitLab auto-retry rule",
        description: "Create or update a GitLab pipeline auto-retry rule.",
        inputSchema: z.object({
      ...
      serviceTool({
        name: "gitlab_delete_auto_retry_rule",
        title: "Delete GitLab auto-retry rule",
        description: "Permanently delete a GitLab pipeline auto-retry rule.",
        inputSchema: z.object({ id: z.string().min(1) }),
        service,
        method: "deleteAutoRetryRule",
        arguments: ({ id }) => [id],
        resultKey: "deleted",
        annotations: WRITE_EXTERNAL_ANNOTATIONS,
      }),
      serviceTool({
        name: "gitlab_get_rate_limits",
        title: "Get GitLab rate limits",
        description: "Get recently observed GitLab API rate-limit snapshots.",
        inputSchema: z.object({}),
        service,
