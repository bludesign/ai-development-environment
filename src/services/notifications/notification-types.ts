export const NOTIFICATION_TYPES = {
  ...
  GITLAB_PIPELINE_SUCCEEDED: {
    key: "GITLAB_PIPELINE_SUCCEEDED",
    category: "GITLAB",
    label: "GitLab pipeline succeeded",
    description: "A GitLab CI/CD pipeline finishes successfully.",
    defaultSidebarEnabled: true,
    defaultBrowserEnabled: true,
    defaultWebPushEnabled: false,
    defaultApnsEnabled: true,
  ...
  GITLAB_PIPELINE_FAILED: {
    key: "GITLAB_PIPELINE_FAILED",
    category: "GITLAB",
    label: "GitLab pipeline failed",
    description: "A GitLab CI/CD pipeline finishes with a failure.",
    defaultSidebarEnabled: true,
    defaultBrowserEnabled: true,
    defaultWebPushEnabled: false,
    defaultApnsEnabled: true,
  ...
  GITLAB_REVIEW_REQUESTED: {
    key: "GITLAB_REVIEW_REQUESTED",
    category: "GITLAB",
    label: "GitLab review requested",
    description: "A GitLab merge request requests a review.",
    defaultSidebarEnabled: true,
    defaultBrowserEnabled: true,
    defaultWebPushEnabled: false,
    defaultApnsEnabled: true,
